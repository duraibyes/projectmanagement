...
<div class="container-fluid">
    <div class="card">
        <div class="card-header p-3 d-flex justify-content-between">
            ...
            <button class="btn primary-btn"> Add Projects</button>
        </div>
            ...
            <table id="example" class="table table-hover table-striped" style="width:100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>61</td>
                        <td>
                            <small onclick="return changeStatus()"
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0)" class="btn btn-info primary-bg text-white">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            <a href="javascript:void(0)" onclick="return changeStatus()"  class="btn btn-danger">
